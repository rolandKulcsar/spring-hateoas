 ...
 * de.escalon.hypermedia.spring.AffordanceBuilder} serves as starting point for affordance creation. Affordance creation
 * works like this: <ol> <li>Dummy call to {@link de.escalon.hypermedia.spring.AffordanceBuilder#linkTo} methods passes
 ...
 * which is necessary to create a link from it, such as {@link de.escalon.hypermedia.spring.AffordanceBuilder#rel
 * (java.lang.String,
 * java.lang.String...)} and other rfc-5988 link parameters</li> <li>Finally, {@link
 * de.escalon.hypermedia.spring.AffordanceBuilder#build} creates the affordance. As a convenience one can also use
 * {@link de.escalon.hypermedia.spring.AffordanceBuilder#withRel} or {@link de.escalon.hypermedia.spring.AffordanceBuilder#withSelfRel}
