...
public class UberJackson2HttpMessageConverter extends AbstractHttpMessageConverter<Object> {
	...
	protected boolean supports(Class<?> clazz) {
		return ResourceSupport.class.isAssignableFrom(clazz) || Collection.class.isAssignableFrom(clazz)
	 ...
	 * {@link com.fasterxml.jackson.databind.ObjectMapper#ObjectMapper() ObjectMapper} is used. Setting a
	 * custom-configured {@code ObjectMapper} is one way to take further control of the JSON serialization process. For
	 * example, an extended {@link com.fasterxml.jackson.databind.ser.SerializerFactory} can be configured that provides
