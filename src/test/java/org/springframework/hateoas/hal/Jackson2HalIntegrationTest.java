...
public class Jackson2HalIntegrationTest extends AbstractJackson2MarshallingIntegrationTest {
	...
	public void setUpModule() {
		...
		mapper.setHandlerInstantiator(new HalHandlerInstantiator(new AnnotationRelProvider(), null, null, RenderSingleLinks.AS_SINGLE));
	}
	...
	public void rendersSingleLinkAsArrayWhenConfigured() throws Exception {
		...
		mapper.setHandlerInstantiator(new HalHandlerInstantiator(new AnnotationRelProvider(), null, null, RenderSingleLinks.AS_ARRAY));
