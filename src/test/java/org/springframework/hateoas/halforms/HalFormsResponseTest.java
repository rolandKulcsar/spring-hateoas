...
import org.springframework.hateoas.halforms.beans.DummyController;
import org.springframework.hateoas.halforms.beans.Item;
...
public class HalFormsResponseTest {
	...
	static DummyController dm;

	static final RelProvider relProvider = new DefaultRelProvider();

	static final CurieProvider curieProvider = new DefaultCurieProvider("test",
